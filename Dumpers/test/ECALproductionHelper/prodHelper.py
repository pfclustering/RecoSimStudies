...
if __name__ == "__main__":
  ...
  # add the dumper part
  if not opt.doskipdumper:
    sbatch_command_dumper = 'jid_d=$(sbatch -p wn --account=cn-test -o logs/dumper.log -e logs/dumper.log --job-name=dumper_{pl} {t} --ntasks=1 --dependency=afterany{dd} launch_dumper.sh)'.format(pl=prodLabel,t='--time=0-00:59',dd=dumper_dependencies)
